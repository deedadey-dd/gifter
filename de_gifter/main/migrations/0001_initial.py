# Generated by Django 5.0.7 on 2024-08-09 12:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='main.vendor')),
            ],
        ),
        migrations.CreateModel(
            name='ItemImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_image_url', models.URLField(blank=True, max_length=240, null=True)),
